...
<!-- Header -->
<section class="bg-grid px-4 pt-20 pb-16 md:px-6 md:pt-28 md:pb-24 lg:px-10 xl:px-16">
...
{#each roleGroups as group, g (group.heading)}
	<section class={['px-4 pb-24 md:px-6 lg:px-10 xl:px-16', g === 0 && 'pt-16 md:pt-24']}>
		<div class="page-container">
...
<section class="px-4 pb-24 md:px-6 lg:px-10 xl:px-16">
	<div class="page-container">
...
<section class="px-4 pb-24 md:px-6 md:pb-32 lg:px-10 xl:px-16">
	<div class="page-container">
